...
export async function CreateUser(req, res) {
    //Get Form Details From Request
    const { Fname, Lname, email, role, gender, mobilenumber, password } = req.body

    //Check for empty feilds
    if (!Fname || !Lname || !email || !role || !gender || !mobilenumber || !password) {
        res.status(400)
    ...
    Fname,  Lname,  email,  role,   gender, mobilenumber,
    password: hashedPassword,
    })
